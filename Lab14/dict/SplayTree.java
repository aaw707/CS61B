...
public class SplayTree implements Dictionary {
  ...
  private void rotateRight(BinaryTreeNode node) { 
    // System.out.println("root:" + root + " node:" + node);
  ...
  private void splayNode(BinaryTreeNode node) {
    // System.out.println("tree before splayNode:" + root);
    if (node == null || node.parent == null) {
      // System.out.println("Illegal call to splayNode().  You have bug #3.");
      return;  // Cannot rotate.
    }
    // zig: node is the child of root
    if (node.parent == root) {
        zig(node);

    // zig-zag: node is right child of a left child,
    // or the left child of a right child
    } else if (node == node.parent.rightChild && node.parent == node.parent.parent.leftChild) {
        zigZag(node);
    
    // zig-zig: node is left child of a left child,
    // or the right child of a right child
    } else {
        zigZig(node);
    }

    // System.out.println("tree after splayNode:" + root);
    // System.out.println("");
    // continue to rotate until node is at root
    if (root != node) {
        splayNode(node);
    }
  }
  ...
  private static void makeUnbalancedTree(SplayTree tree) {
    tree.insert(Integer.valueOf(10), "A"); 
    tree.insert(Integer.valueOf(9), "B"); 
    tree.insert(Integer.valueOf(8), "C"); 
    tree.insert(Integer.valueOf(7), "D"); 
    tree.insert(Integer.valueOf(6), "E"); 
    tree.insert(Integer.valueOf(5), "F"); 
    tree.insert(Integer.valueOf(4), "G"); 
    tree.insert(Integer.valueOf(3), "H"); 
    tree.insert(Integer.valueOf(2), "I"); 
    tree.insert(Integer.valueOf(1), "J"); 
  }
  ...
  public static void main(String[] args) {
    ...
    tree.insert(Integer.valueOf(1), "G");
    tree.insert(Integer.valueOf(3), "O");
    Entry testEntry = tree.insert(Integer.valueOf(2), "O");
    BinaryTreeNode testNode =
      tree.findHelper((Comparable) testEntry.key, tree.root);
    tree.insert(Integer.valueOf(5), "J");
    tree.insert(Integer.valueOf(4), "D");
    tree.insert(Integer.valueOf(7), "B");
    tree.insert(Integer.valueOf(6), "O");
    ...
    tree2.insert(Integer.valueOf(3), "A");
    tree2.insert(Integer.valueOf(7), "B");
    tree2.insert(Integer.valueOf(4), "C");
    tree2.insert(Integer.valueOf(2), "D");
    tree2.insert(Integer.valueOf(9), "E");
    tree2.insert(Integer.valueOf(1), "F");
