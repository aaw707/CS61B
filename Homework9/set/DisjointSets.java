...
public class DisjointSets {
  ...
  public void union(int root1, int root2) {
    ...
    int set2 = find(root2);
    if (set1 != root1) {
        System.out.println("ERROR: root1 is not root of its set");
        System.exit(0);
    } else if (set2 != root2) {
        System.out.println("ERROR: root2 is not root of its set");
        System.exit(0);
    } else if (set1 == set2) {
        System.out.println("ERROR: root1 and root2 are from the same set");
        System.exit(0);
    }
