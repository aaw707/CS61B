// downloaded from forum
  ...
  public static void main (String[] args) {
    // Fill in your solution for Part I here.
	  ...
	  DList sl1 = new DList();
    sl1.insertBack(Integer.valueOf(6));
    sl1.insertBack(Integer.valueOf(9));
    sl1.insertBack(Integer.valueOf(12));
    System.out.println("Here is a list after insertBack 6, 9, 12: "
		       + sl1.toString());
    System.out.println();
    
    
    sl1.insertFront(Integer.valueOf(3));
    sl1.insertBack(Integer.valueOf(15));
  ...
  private static void testEmpty() {
    ...
    lst2.insertBack(Integer.valueOf(5));
  ...
  private static void testAfterInsertFront() {
    ...
    lst1.insertBack(Integer.valueOf(4));
  ...
  private static void testAfterinsertBack() {
    DList lst1 = new DList();
    lst1.insertBack(Integer.valueOf(6));
    lst1.insertBack(Integer.valueOf(7));
    System.out.println();
  ...
  private static void newtest(DList sl1) {
	  ...
	  System.out.println("After remove the front, the front() should be 6. It is: " +
		       sl1.front().item);
	  node = sl1.front();
	  sl1.insertBefore(Integer.valueOf(5),node);
	  sl1.insertAfter(Integer.valueOf(8),node);
