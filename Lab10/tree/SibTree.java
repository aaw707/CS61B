...
public class SibTree extends Tree {
  ...
  public static void main(String[] args) {
    ...
    Tree t = new SibTree(Integer.valueOf(11));
    t.insertRoot(Integer.valueOf(1));
    ...
    r32 = null;
    try {
      r.insertChild(Integer.valueOf(13), 1000);
      r.insertChild(Integer.valueOf(12), 2);
      r2 = r.child(2);
      r3 = r.child(3);
    ...
    try {
      ...
      r3.insertChild(Integer.valueOf(132), 1);
      r3.insertChild(Integer.valueOf(131), 1);
      r31 = r3.child(1);
      r32 = r3.child(2);
    ...
    try {
      if (r.parent() == null) {
        ...
        r.parent().insertChild(Integer.valueOf(0), 1);
