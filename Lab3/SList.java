...
public class SList {
  ...
  public static void main (String[] args) {
    ...
    System.out.println("Constructing a list looks like [  6  9  12  ]");
    SList lst1 = new SList();
    lst1.insertFront(Integer.valueOf(12));
    lst1.insertFront (Integer.valueOf(9));
    lst1.insertFront(Integer.valueOf(6));
    System.out.println(lst1.toString());

    System.out.println("Adding more lines to update the list to [  3  6  9  12  15  ]");
